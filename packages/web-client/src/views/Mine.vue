<template>
  <div class="container">
    <div class="top">
      ...
      <div class="wrap">
        <div class="fan">粉丝：<span class="number">222</span></div>
        <div class="follow">关注：<span class="number">102</span></div>
      </div>
    </div>
    <div class="personal">
      ...
      <div class="video">
        <Grid :column-num="3" :gutter="5">
          <GridItem v-for="(item, index) in user_info.video_info" :key="index">
            <img
